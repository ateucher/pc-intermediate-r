...
::: {.columns}
::: {.column width="50%"}
![](img/tables-join-1.png){fig-align="center"}
:::

::: {.column width="50%"}
![](img/tables-join-2.png){fig-align="center"}
:::
:::
...
- Drops rows in the right table that don't match
...
- Drops rows in the left table that don't match
