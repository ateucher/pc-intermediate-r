...
::: {.question .fragment}
[Your turn:]{.color-yellow} Scale all numeric columns (use `across()`) in `rodents` to have mean 0 and standard deviation 1. *(Hint: Check out the `scale()` function)*
:::
...
```{r}
#| eval: false
#| code-line-numbers: "|1,2,3,6,7|13|14"
pivot_longer(
  data,
  cols,
  ...,
