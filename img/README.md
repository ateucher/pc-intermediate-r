...
- The diagram of the `fahrenheit_to_celsius()` function is from the Software Carpentries [Functions lesson](https://swcarpentry.github.io/r-novice-inflammation/02-func-R.html). Carpentries material is available under Creative Commons Attribution 4.0 International (CC BY 4.0) license.
