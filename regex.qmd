...
## Replace all occurrences: `str_replace_all()` {visibility="hidden"}
...
- It's often easier to pipe multiple `stringr` functions together than to write one complex regex
...
You're going to have to look things up a lot!
:::

## Resources

- **`stringr` cheatsheet**: [posit.co/resources/cheatsheets](https://posit.co/resources/cheatsheets/)
- **Regular Expressions Help**: [regular-expressions.info/](https://www.regular-expressions.info/)
