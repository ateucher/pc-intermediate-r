...
## What is Git? [{{< fa brands git-alt size=lg >}}]{style="color: orange;"}
...
# Let's &nbsp;[{{< fa brands git size=lg >}}]{style="color: orange;"}&nbsp; set up! [{{< fa brands git-alt size=xl >}}&emsp;{{< fa brands github size=xl >}}]{style="float: right; padding-right: 100px;"}
...
*This can all be done from with Positron, using `usethis` git-related functions, 
or a combination of using the GitHub web interface and `git` command-line instructions*
...
## Creating a pull request to contribute to an existing project
