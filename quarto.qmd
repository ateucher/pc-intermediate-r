...
- Supports multiple data science languages (R, Python, Julia, Observable)
...
- Images:
    - `![rainbow cat](https://media.giphy.com/media/BSx6mzbW1ew7K/giphy.gif)` -> ![rainbow cat](https://media.giphy.com/media/BSx6mzbW1ew7K/giphy.gif){style="width:150px;"}
...
## Example Code Chunk with Options
...
- Access parameters in code chunks via the `params` object
...
### Bonus:
- Render the document for a different island by specifying the parameter at the command line or using `quarto::quarto_render()` in R.
